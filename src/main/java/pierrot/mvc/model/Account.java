...
public class Account {
	 ...
	 * among other entities of the same type in the system. Should typically only be
	 * called by privileged data access infrastructure code such as an Object
	 ...
	 * 
	 * @param creditCardNumber The credit card number. Specify null or the empty
	 *                         string for no card.
	 */
	public void setCreditCardNumber(String creditCardNumber) {
		this.creditCardNumber = StringUtils.hasText(creditCardNumber) ? creditCardNumber : NO_CREDIT_CARD;
	}
	 ...
	 *                             this account
	 */
	public void addTransaction(String accountName, String accountNumber, String bankCode, MonetaryAmount amount) {
		transactions.add(new Transaction(accountName, accountNumber, bankCode, amount));
	}

	/**
	 * Returns a single account transaction. Callers should not attempt to hold on
	 ...
	 * 
	 * @param name the name of the transaction account e.g "Fred Smith"
	...
	public String toString() {
		return "[Account number = '" + number + "', type = '" + type + "', balance = '" + balance + "'. cc = '"
				+ creditCardNumber + "']"; // + transactions = " + transactions;
	}
